...
const WEIGHT_KEY: number = 0.9;
const WEIGHT_MODE: number = 1.5;
const WEIGHT_DURATION: number = 4.0;
const WEIGHT_DURATION_POWER: number = 0.78;
const WEIGHT_TEMPO: number = 1.2;
const WEIGHT_TEMPO_POWER: number = 1;
const WEIGHT_DANCEABILITY: number = 1.2;
const WEIGHT_DANCEABILITY_POWER: number = 1;
const WEIGHT_ENERGY: number = 1;
const WEIGHT_VALENCE: number = 1.2;

const WEIGHT_ACOUSTICNESS: number = 1.2;
const WEIGHT_LIVENESS: number = 1.2;
